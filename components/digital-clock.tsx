...
export default function DigitalClock() {
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-gradient-to-r from-purple-800 to-violet-900">
      {/* Center the digital clock within the screen */}
      <Card className="p-8 shadow-lg rounded-2xl bg-white bg-opacity-70">
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="text-6xl font-bold tracking-tight text-purple-600">
            {formattedTime}
          </div>
          ...
          <div className="mt-4 flex items-center">
            <Button
              ...
              className="mr-2 font-bold bg-blue-500 hover:bg-blue-600 text-white"
            >
              24-Hour Format
            </Button>
            <Button
              ...
              className="mr-2 font-bold bg-purple-500 hover:bg-purple-600 text-white"
            >
              12-Hour Format
            </Button>
          </div>
          {/* Copyright Notice */}
          <div className="mt-6 text-xs text-400">
            © {new Date().getFullYear()} by Zeenat Somroo
          </div>
        </div>
      </Card>
    </div>
